        ...
        stage('Cloning github repo to jenkins'){
            steps{
                script{
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/Nabarundutta/hotel_booking_forecast.git']])
                }
            }
        }
